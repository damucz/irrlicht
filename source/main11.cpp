...
/*
		...
		video::ITexture* normalMap =
			driver->getTexture("rockwall_NRM.tga");
*/
		/*
		...
		*/
		...
		room->setMaterialTexture(0,
				driver->getTexture("rockwall.jpg"));
	...
	*/
	...
	scene::IAnimatedMesh* earthMesh = smgr->getMesh("earth.x");
	if (earthMesh)
	{
		...
		video::ITexture* earthNormalMap = driver->getTexture("earthbump.jpg");
		if (earthNormalMap)
		{
	...
	*/
	...
	bill->setMaterialTexture(0, driver->getTexture("particlegreen.jpg"));
