...
//! _IRR_MARMALADE_PLATFORM_ for marmalade
...
#if defined(_IRR_MARMALADE_PLATFORM_)
#define _IRR_COMPILE_WITH_OGLES1_
#define _IRR_COMPILE_WITH_OGLES2_
#ifdef _IRR_IPHONE_PLATFORM_
#undef _IRR_IPHONE_PLATFORM_
#endif
...
#if !defined(_IRR_WINDOWS_API_) && !defined(_IRR_OSX_PLATFORM_) && !defined(_IRR_ANDROID_PLATFORM_) && !defined(_IRR_MARMALADE_PLATFORM_)
...
define out. */
#if !defined(_IRR_IPHONE_PLATFORM_) && !defined(_IRR_ANDROID_PLATFORM_) && !defined(_IRR_MARMALADE_PLATFORM_)
